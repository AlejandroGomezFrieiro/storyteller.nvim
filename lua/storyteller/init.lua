...
M.setup = function(opts)
  ...
  km.register("<leader>sy", "<cmd>Story timeline<cr>", "Timeline")
  km.register("<leader>sf", "<cmd>Story threads<cr>", "Plot threads")
  km.register("<leader>sh", "<cmd>Story health<cr>", "Story health")
