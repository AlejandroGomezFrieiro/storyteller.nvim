...
function M.remember(prj)
  ...
  local scene = prj and scene_data.current(prj)
  if not scene then return end
  local data = {
    path = scene.path,
    id = scene_data.from_index(scene).meta.id,
